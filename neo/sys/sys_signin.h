...
public:
	...
	idSignInManagerBase() :
	  ...
	  void 					SetDesiredLocalUsers( int aMinDesiredLocalUsers, int aMaxDesiredLocalUsers ) { this->minDesiredLocalUsers = aMinDesiredLocalUsers; this->maxDesiredLocalUsers = aMaxDesiredLocalUsers; }
