...
========================
*/
void idJobThread::Start( core_t core, unsigned int aThreadNum ) {
	this->threadNum = aThreadNum;
	StartWorkerThread( va( "JobListProcessor_%d", aThreadNum), core, THREAD_NORMAL, JOB_THREAD_STACK_SIZE );
}
