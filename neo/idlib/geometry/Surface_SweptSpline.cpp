...
====================
*/
void idSurface_SweptSpline::SetSpline( idCurve_Spline<idVec4> *aSpline ) {
	if ( this->spline ) {
		delete this->spline;
	}
	this->spline = aSpline;
...
====================
*/
void idSurface_SweptSpline::SetSweptSpline( idCurve_Spline<idVec4> *aSweptSpline ) {
	if ( this->sweptSpline ) {
		delete this->sweptSpline;
	}
	this->sweptSpline = aSweptSpline;
}
